...
$(document).ready(function() {
    ...
    $('#sports li a').click(function(){
        ...
        var date = new Date();
        date.setDate(sportClicked);
        sessionStorage.currentDate = sportClicked;
        refreshEntries();
    });
    ...
    db.transaction(
        function(transaction) {
            transaction.executeSql(
                ...
                ' date DATE NOT NULL, score1 INTEGER NOT NULL, ' +
...
function createEntry() {
    ...
    db.transaction(
        function(transaction) {
            transaction.executeSql(
                'INSERT INTO entries (date, score2, score1, team1, team2) VALUES (?, ?, ?, ?, ?);',
                [date, score2, score1, team1, team2],
                function(){
                    refreshEntries();
                    jQT.goBack();
                },
